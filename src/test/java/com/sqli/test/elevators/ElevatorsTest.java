...
import com.sqli.main.elevators.Building;
...
public class ElevatorsTest {
    ...
    public void  the_closest_elevator_to_top_floor_should_arrive_first() {
        ...
        Building building = new Building(elevatorDispatcher, numberOfFloors, "id1:1", "id2:6");// "[elevator_id]:[elevator_current_floor]"
    ...
    public void elevators_going_down_arrive_last_to_top_floor() {
        Building building = new Building(elevatorDispatcher, 10, "id1:1", "id2:6");
    ...
    public void elevators_going_up_should_be_compared_to_those_resting() {
        Building building = new Building(elevatorDispatcher, 10, "id1:1", "id2:6", "id3:5");
        building.move("id1", "UP");
        building.move("id2", "DOWN");
